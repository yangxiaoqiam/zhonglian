...
<head>
    ...
    <![endif]-->
    <style type="text/css">
    .wh-pg-login .wh-main{width: 1160px;    width: 1160px;
    position: absolute;
    left: 50%;
    margin-left: -580px;
    top: 50%;
    margin-top: -30px;}
        .wh-pg-login .wh-main .wh-login-cons.wh-lg-no-button .wh-lg-logoIn{ position: relative;margin:0 auto;width: 1160px;height: 60px;top:0;text-shadow: none;}
        .wh-pg-login .wh-main .wh-lg-logoIn .wh-lg-logoIn-top form{width: 100%;}
        .wh-pg-login .wh-main .wh-lg-logoIn .wh-lg-logoIn-top form div{font-size: 18px;}
        .wh-pg-login .wh-main .wh-lg-logoIn .wh-lg-logoIn-top form div.name-a,.wh-pg-login .wh-main .wh-lg-logoIn .wh-lg-logoIn-top form div.password-a,.wh-pg-login .wh-main .wh-lg-logoIn .wh-lg-logoIn-top form div.language-a{margin:0 10px 0 25px;height: 35px;line-height: 35px;   color: #333; }
        .wh-pg-login .wh-main .wh-lg-logoIn .wh-lg-logoIn-top form div.vali-pass, .wh-pg-login .wh-main .wh-lg-logoIn .wh-lg-logoIn-top form div.vali-username{
    ...
    .wh-pg-login .wh-main .wh-login-top ul.wh-login-tips{
         position: relative;
         margin:0 5px; 
    }
    .wh-pg-login .wh-main .wh-login-top ul.wh-login-tips li a span{
         font-size: 16px;
    }
    .wh-pg-login .wh-main .wh-login-top ul.wh-login-tips li{
         height: 37px;
         line-height: 37px;
    }
    .wh-pg-login .wh-main .wh-lg-logoIn .wh-lg-logoIn-top form div.vali-submit{
         position: relative;
    }
    .wh-pg-login .wh-main .wh-lg-logoIn .wh-lg-logoIn-top form div input.sub{
         background: url(/defaultroot/rd/img/icons.png) top center repeat-y;
         height: 37px;
         line-height: 37px;
    }
    .wh-pg-login .wh-main .wh-lg-logoIn .wh-lg-logoIn-top form div input.sub:hover{
        background: url(/defaultroot/rd/img/icons.png) top center repeat-y;
    }
    .wh-pg-login .wh-main .wh-lg-logoIn .wh-lg-logoIn-top form div.qingchu.qingchu{
         background: url(/defaultroot/rd/img/icons.png) top center repeat-y;
         height:37px;
         line-height: 34px;
             color: #fff;
    ...
    width: 90px;
     ...
     .wh-pg-login .wh-main .wh-lg-logoIn .wh-lg-logoIn-top form div.qingchu input{
         color: #fff;
         font-size: 16px;
...
.wh-pg-login .wh-main .wh-login-cons,.wh-pg-login .wh-main .wh-lg-logoIn .wh-lg-logoIn-top{
     height: auto;
}
.wh-pg-login .wh-main .wh-login-top ul.wh-login-tips li a{color: #333;text-shadow:none;}
.bottom-a{
         padding: 10px 0 0;
    text-align: center;
    font-size: 12px;
...
.logo-a{
 ...
 .wh-pg-login .wh-lg-slider .flexslider ul li{
            ...
            <div class="wh-login-cons" id = "submitTyle">
               ...
               <!--  <div class="wh-lg-loIn-bg"></div> -->
                ...
                <div class="wh-lg-logoIn" >
                	<div class="logo-a"><a href="#"><img src="/defaultroot/rd/img/logo.png"></a></div>
                    <div class="wh-lg-logoIn-top" >
                       <!--  <a href="javascript:void(0)"><img src="" class="user" id = "empLivingPhoto" onclick ="submitByPhoto()" /></a> -->
                        <form id="LogonForm" name="LogonForm" action="Logon!logon.action" method="post">
                            ...
                            <div class="name-a fl">用户名：</div>
                            <div class="vali-username fl">
                                <!-- <i class="fa fa-user" id = "userStyle"></i> -->
                                <input type="text" id="userAccount" name="userAccount" value="" class="info"/>
                            </div>
							<div class="password-a fl">密码：</div>
                            <div class="vali-pass fl">
                            ...
                            <div class="language-a fl">语言：</div>
                            <select class="select-a fl">
                                  <option>简体中文</option>
                                  <option>繁體中文</option>
                            ...
                            <div class="wh-login-top fl">
                                    <!-- <h1> 
                                      <img src="" id="loginPic" data-pich="80" style="display: none;">
                                    </h1> -->
                                    <ul class="wh-login-tips">
                                        <li> <a href="/defaultroot/public/edit/logindownload/Logindownload.jsp?fileName=activex.msi" class="widget"><!-- <i class="fa fa-cog2"></i> --><span>控件安裝</span></a></li>
                                        <li style="display:none"><a href="javascript:addFavorite()" class="collect"><i class="fa fa-plus-circle"></i><span>收藏地址</span></a></li>
                                        <!-- <li><a href="/defaultroot/help/help_set.html" class="help"><i class="fa fa-question-circle"></i><span>設置幫助</span></a></li> -->
                                    </ul>
                                </div>
                                <div class="vali-submit fl">
        ...
        <div class="wh-lg-slider">
                <div class="flexslider">
                        <ul class="slides">
			                ...
			                if(logobgSaveNameArr!=null){
			                    for(int i=0;i<logobgSaveNameArr.length;i++){
			                    	...
			                    	%> 		
					                    <li style="background:url('<%=logobgpath+logobgSaveNameArr[i]%>')"></li>
					                <% 
			                    	}
					                }}
					        %>
                 ...
                 <div class="bottom-a">
                    ...
                    <p >如果您是第一次使用本系统，请点击  <a href="#" style="color:red">此处</a> 下载使用手册</p>
                     <p >如果您需要直接下载移动端，请点击 <a href="#" style="color:red">此处</a>  下载安装包  </p>
                 </div>
         </div>
    </div>
</div>
